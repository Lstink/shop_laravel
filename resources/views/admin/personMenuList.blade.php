                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-body ">
                            <table class="layui-table" lay-data="{url:'{{ route('getJsonMenu') }}',page:true,toolbar: '#toolbarDemo',id:'test'}" lay-filter="test">
                                <thead>
                                    <tr>
                                        <th lay-data="{type:'checkbox'}">ID</th>
                                        <th lay-data="{field:'id', width:80, sort: true}">id</th>
                                        <th lay-data="{field:'tag_id', width:80, sort: true}">标签id</th>
                                        <th lay-data="{field:'tag_name', width:100}">标签名</th>
                                        <th lay-data="{field:'sex',  sort: true}">性别</th>
                                        <th lay-data="{field:'menuid', minWidth: 150}">个性化菜单menuid</th>
    ...
    <script>layui.use(['laydate','form'],
        ...
        function member_del(obj){
                layer.confirm('确认要删除吗？',function(index){
                    //发异步删除数据
                    var id = $(obj).parents('td').prev().text();
                    $.ajaxSetup({
                        headers: {
