...
<div class="layui-form-item">
    ...
    <div class="layui-input-block">
        <div class="layui-btn-group demoTest" style="margin-top: 5px;">
            <button class="layui-btn layui-btn-sm btns" style="background-color: #5FB878;" type="text">文本消息</button>
        ...
        <span style="margin-left: 30px;">选择回复类型</span>
        <div class="layui-btn-group demoTest" style="margin-top: 5px;">
            <button class="layui-btn layui-btn-sm ch" style="background-color: #5FB878;" type="text">文本消息</button>
            <button class="layui-btn layui-btn-sm ch" type="image">图片消息</button>
            <button class="layui-btn layui-btn-sm ch" type="voice">语音消息</button>
            <button class="layui-btn layui-btn-sm ch" type="music">音乐消息</button>
            <button class="layui-btn layui-btn-sm ch" type="video">视频消息</button>
            <button class="layui-btn layui-btn-sm ch" type="news">图文消息</button>
        </div>
    </div>
...
<div class="main_content">
    ...
    <div class="one dd" type="text">
        <div class="layui-form-item">
            <label class="layui-form-label">首次关注回复消息</label>
            <div class="layui-input-block">
                <input type="text" name="content" autocomplete="off" placeholder="请输入首次关注回复内容" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block">
...
<script>
    $(function(){
        layui.use(['layer','form','upload'], function(){
            ...
            //读取回复类型
            var type = '{{ config('responseType.responseType') }}';
            $('.ch').each(function(){
