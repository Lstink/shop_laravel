@include('public.header')
    ...
    <script type="text/html" id="toolbarDemo">
        <div class = "layui-btn-container" > 
            ...
            <button class = "layui-btn layui-btn-danger layui-btn-sm" lay-event = "createTag" onclick="">创建标签</button>
        ...
        function() {
            ...
            function(obj) {
                ...
                switch (obj.event) {
                    ...
                    case 'createTag':
                        if (arr.length <1) {
                            xadmin.open('新建标签','{{ route('createTag') }}',600,200);
                        }else{
                            //将数组转化为字符串
                            var id = arr.join(',');
                            xadmin.open('选择标签','{{ route('selectTag') }}'+'/'+id,600,400);
                        }
                        break;
                    case 'send':
                        if (arr.length <2) {
