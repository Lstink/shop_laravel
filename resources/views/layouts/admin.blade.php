@include('public.header')
        ...
        <div class="container">
            <div class="logo">
                <a href="{{ route('wxIndex') }}">微信公众号后台管理</a></div>
            <div class="left_open">
        ...
        <div class="left-nav">
            <div id="side-nav">
                <ul id="nav">
                    ...
                    <li>
                        <a href="javascript:;">
                            <i class="iconfont left-nav-li" lay-tips="微信菜单管理">&#xe723;</i>
                            <cite>微信菜单管理</cite>
                            <i class="iconfont nav_right">&#xe697;</i></a>
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('新建菜单','{{ route('createMenu') }}')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>新建菜单</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('菜单列表','{{ route('MenuList') }}')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>菜单列表</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('个性化菜单列表','{{ route('personMenuList') }}')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>个性化菜单列表</cite></a>
                            </li>
                        </ul>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('用户列表','{{ route('userList') }}')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>用户列表</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('用户标签管理','{{ route('tagList') }}')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>用户标签管理</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('粉丝列表','{{ route('fansList') }}')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>粉丝列表</cite></a>
                            </li>
                            <li>
                    ...
                    <li>
                        <a href="javascript:;">
                            <i class="iconfont left-nav-li" lay-tips="微信管理">&#xe6b4;</i>
                            <cite>微信公众号管理</cite>
                            <i class="iconfont nav_right">&#xe697;</i></a>
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('首次关注回复','{{ route('subscribe') }}')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>首次关注回复</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('素材管理','{{ route('subscribeList') }}')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>素材管理</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('关键字回复','{{ route('keywords') }}')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>关键字回复</cite></a>
                            </li>
