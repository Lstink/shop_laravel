...
<html lang="zh-cn">
  ...
  <body>
      ...
      <table>
       <tr>
        <td width="50%">
         ...
         <time>创建日期：{{ $orderInfo -> create_time }}<br />失效日期：{{ @$end_time }}</time>
    ...
    <div class="gwcpiao">
     <table>
      <tr>
       <td width="50%"><a href="{{ route('prolist') }}" class="jiesuan" style="background:#5ea626;">继续购物</a></td>
       <td width="50%"><a href="{{ route('aliPay',['order_id'=>$orderInfo->order_id]) }}" class="jiesuan">立即支付</a></td>
      </tr>
     </table>
    </div><!--gwcpiao/-->
    </div><!--maincont-->
